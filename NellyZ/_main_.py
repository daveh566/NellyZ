...
from NellyZ import TOKEN, bot, dp
from NellyZ.config import get_bool_key, get_list_key
from NellyZ.modules import ALL_MODULES, LOADED_MODULES, MOD_HELP
...
import_module("NellyZ.modules.pm_menu")
# Import misc stuff
import_module("NellyZ.utils.exit_gracefully")
if not get_bool_key("DEBUG_MODE"):
    import_module("NellyZ.utils.sentry")
