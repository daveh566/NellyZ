...
# Copyright (C) 2021 TeamKayAspirer
# Copyright (C) 2020 
...
async def select_lang_keyboard(message, strings, edit=False):
    ...
    markup.add(
        InlineKeyboardButton(
            strings["crowdin_btn"], url="https://t.me/KayAspirerProject"
        )
    )
    if edit:
...
__help__ = """
This module is dedicated towards utlising Nelly's localization feature! You can also <a href='https://crowdin.com/project/DaisyXx'>contribute</a> for improving localization in Daisy!
...
Nelly will send you bunch of inline buttons where you can select your prefered language interatively without any hassles!
"""
